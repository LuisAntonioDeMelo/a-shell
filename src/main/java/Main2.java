...
public class Main2 {
    public static void main(String[] args) throws Exception {
        ...
        while (!exit) {
            ...
            if (Objects.equals(command, "exit")) exit = true;
            else if (Objects.equals(command, "echo")) System.out.println(result);
            else if (Objects.equals(command, "type")) System.out.println(type(result));
            else if (Objects.equals(command, "pwd")) System.out.println(cwd);
            else if (Objects.equals(command, "cd")) {
                File file = new File(result);
                if (file.isDirectory() && file.isAbsolute()) cwd = file.getAbsolutePath();
                else System.out.println("cd: " + result + ": No such file or directory");
